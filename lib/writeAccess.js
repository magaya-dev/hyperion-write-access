 ...
 * @property {Function} delete - Deletes an object in the database. Must be called on database object.
 */
...
module.exports = function (asyncApi) {
    ...
    const del = new WriteAccess(asyncApi.deleteAsync);

    this.save = obj => save.op(obj);
    this.edit = obj => edit.op(obj);
    this.delete = obj => del.op(obj);
};